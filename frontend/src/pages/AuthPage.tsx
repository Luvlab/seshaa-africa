...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Top brand bar */}
      <div className="p-5 flex items-center gap-3" style={{ backgroundColor: 'var(--cp)' }}>
        <Globe size={32} className="text-white" strokeWidth={1.5} />
        <div>
          <span className="text-white font-black text-2xl">Seshaa</span>
          <span className="text-white/70 text-sm">.africa</span>
        </div>
      </div>
